...
router.get('/securedResource', authMiddleware, (req, res) => {
    ...
    res.json({ message: 'You are authenticated', userId: req.user.userId, role: req.user.role,userName: req.user.userName,occupation:req.user.occupation,email:req.user.email});
  });
